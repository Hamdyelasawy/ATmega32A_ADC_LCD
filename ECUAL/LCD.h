...
#define LCD_Control_reg_DIR GPIOA->ddr.data
#define LCD_Control_reg_OP  GPIOA->port.data
#define LCD_Control_reg_IP	GPIOA->pin.data

#define LCD_Data_Reg_DIR GPIOA->ddr.data
#define LCD_Data_Reg_OP	 GPIOA->port.data
#define LCD_Data_Reg_IP	 GPIOA->pin.data
